...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println(evolution.GetEvolutionChainList())
	},
}
...
func init() {
	...
	// evolutionCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// evolutionCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
