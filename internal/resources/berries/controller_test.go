...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rBerries, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rBerries, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rFirmnesses, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rFirmnesses, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rFlavors, "Expected to have type 'NamedResourceList' struct.")
