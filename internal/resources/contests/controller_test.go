...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rType, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rType, "Expected to not have an empty struct.")
	assert.IsType(t, &models.ResourceList{}, rEffect, "Expected to have type 'ResourceList' struct.")
	assert.NotEmpty(t, rEffect, "Expected to not have an empty struct.")
	assert.IsType(t, &models.ResourceList{}, rSuper, "Expected to have type 'ResourceList' struct.")
