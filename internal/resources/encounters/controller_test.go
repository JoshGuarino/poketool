...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rMethod, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rMethod, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rCondition, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rCondition, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rValue, "Expected to have type 'NamedResourceList' struct.")
