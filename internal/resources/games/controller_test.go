...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rGen, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rGen, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rPokedex, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rPokedex, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rVersion, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rVersion, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rGroup, "Expected to have type 'NamedResourceList' struct.")
