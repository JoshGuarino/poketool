...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rItem, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rItem, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rAttribute, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rAttribute, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rCatergory, "Expected to have type 'Result' struct.")
	assert.NotEmpty(t, rCatergory, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rFling, "Expected to have type 'Result' struct.")
	assert.NotEmpty(t, rFling, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rPocket, "Expected to have type 'Result' struct.")
	assert.NotEmpty(t, rPocket, "Expected to not have an empty struct.")
