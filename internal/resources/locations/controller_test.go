...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rLocation, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rLocation, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rArea, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rArea, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rPalPark, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rPalPark, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rRegion, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rRegion, "Expected to not have an empty struct.")
