...
func TestGetList(t *testing.T) {
	...
	assert.IsType(t, &models.NamedResourceList{}, rMove, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rMove, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rAilment, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rAilment, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rBattle, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rBattle, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rCategory, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rCategory, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rDamage, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rDamage, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rLearn, "Expected to have type 'NamedResourceList' struct.")
	assert.NotEmpty(t, rLearn, "Expected to not have an empty struct.")
	assert.IsType(t, &models.NamedResourceList{}, rTarget, "Expected to have type 'NamedResourceList' struct.")
